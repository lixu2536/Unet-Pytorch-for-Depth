...
class U_Net(nn.Module):
    ...
    """
    def __init__(self, in_ch=1, out_ch=1):  # in_ch=3
        ...
        self.Maxpool5 = nn.MaxPool2d(kernel_size=2, stride=2)   # add to 1024
        ...
        self.Conv6 = conv_block(filters[4], filters[5])     # add to 1024
